...
private:
	...
	cTask<cMessageParams> process_ban(cInteraction&, uint32_t, const cSnowflake&, std::string_view, std::uint16_t, std::string_view, std::chrono::seconds, std::string_view, std::string_view);
