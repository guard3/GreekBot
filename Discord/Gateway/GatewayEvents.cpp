...
enum eEvent : uint32_t {
	...
	EVENT_MESSAGE_REACTION_ADD          = 0x5D4F2489,
	EVENT_MESSAGE_REACTION_REMOVE       = 0x5295D7D8,
	EVENT_MESSAGE_REACTION_REMOVE_ALL   = 0x02A1D6E9,
	EVENT_MESSAGE_REACTION_REMOVE_EMOJI = 0xEB390E5D,
...
cGateway::implementation::process_event(const json::value& v) try {
	...
	switch (const json::value& d = v.at("d"); type) {
		...
		case EVENT_MESSAGE_REACTION_ADD: {
			auto& o = d.as_object();
		...
		case EVENT_MESSAGE_REACTION_REMOVE: {
			auto& o = d.as_object();
			auto user_id = json::value_to<cSnowflake>(o.at("user_id"));
			auto channel_id = json::value_to<cSnowflake>(o.at("channel_id"));
			auto message_id = json::value_to<cSnowflake>(o.at("message_id"));
		...
		case EVENT_MESSAGE_REACTION_REMOVE_ALL: {
			auto& o = d.as_object();
			auto channel_id = json::value_to<cSnowflake>(o.at("channel_id"));
			auto message_id = json::value_to<cSnowflake>(o.at("message_id"));
			hSnowflake guild_id;
		...
		case EVENT_MESSAGE_REACTION_REMOVE_EMOJI: {
			auto& o = d.as_object();
			auto channel_id = json::value_to<cSnowflake>(o.at("channel_id"));
			auto message_id = json::value_to<cSnowflake>(o.at("message_id"));
			cEmoji emoji(o.at("emoji"));
